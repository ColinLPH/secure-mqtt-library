...
int to_smoqer_seq_num;
int from_smoqer_seq_num;
...
{
    generate_nonce(key, to_smoqer_seq_num, nonce); //should probably move this out of this function
...
void send_mqtt_encrypted(int sock,
                         ...
                         const unsigned char *key)
{
    printf("Sending packet %d to smoqer\n", to_smoqer_seq_num);
...
{
    printf("Receiving packet %d from smoqer\n", from_smoqer_seq_num);
